...
abstract public class BaseBottomSheetDialogFragment : BottomSheetDialogFragment(), View.OnTouchListener {

    companion object {
        private val TAG : String = BaseBottomSheetDialogFragment::class.java.getSimpleName()
    }
    ...
    protected fun showSnackBar(messageToast : String, duration : Int) {
